...
pluralCaseList.push( {plural: "paymentLists", pascal: "PaymentList"} )

pluralCaseList.push( {plural: "carts", pascal: "Cart"} )
pluralCaseList.push( {plural: "cancellations", pascal: "Cancellation"} )
